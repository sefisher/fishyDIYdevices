const char WEBSTRPT1[] PROGMEM = "<!DOCTYPE html>"
"<html>"
"<head>"
...
"document.getElementById('pctOpenVal-'+ii).value = posPct(d.motorPos,d.motorPosAtCCW,d.motorPosAtCW);"
"document.getElementById('pctOpenSld-'+ii).value = posPct(d.motorPos,d.motorPosAtCCW,d.motorPosAtCW);"
"document.getElementById('ccwLimVal-'+ii).value = d.motorPosAtCCW;"
"document.getElementById('ccwLimVal-'+ii).min = d.motorPosAtFullCCW;"
"document.getElementById('ccwLimVal-'+ii).max = d.motorPosAtFullCW;"
"document.getElementById('ccwLimSld-'+ii).value = d.motorPosAtCCW;"
"document.getElementById('ccwLimSld-'+ii).min = d.motorPosAtFullCCW;"
"document.getElementById('ccwLimSld-'+ii).max = d.motorPosAtFullCW;"
"document.getElementById('cwLimVal-'+ii).value = d.motorPosAtCW;"
"document.getElementById('cwLimVal-'+ii).min = d.motorPosAtFullCCW;"
"document.getElementById('cwLimVal-'+ii).max = d.motorPosAtFullCW;"
"document.getElementById('cwLimSld-'+ii).value = d.motorPosAtCW;"
"document.getElementById('cwLimSld-'+ii).min = d.motorPosAtFullCCW;"
"document.getElementById('cwLimSld-'+ii).max = d.motorPosAtFullCW;"
...
"if(d.dead=='0'){"
"ii=d.deviceID;"
"addDiv = '<div class=\"CP\"><input type=hidden id=\"targetIP-'+ii+'\" value=\"'+d.IP+'\"><div class=\"CPhd\">\"'+d.deviceName+'\"</div><div class=\"CPhd2\">('+mstrTxt+d.IP+')</div><div class=\"sldRow\"><div class=\"sldLab\">% Open</div><input class=\"sld\" id=\"pctOpenSld-'+ii+'\" type=range value='+posPct(d.motorPos,d.motorPosAtCCW,d.motorPosAtCW)+' max=100 min=0 oninput=\"sync('+ii+',\"pctOpen\",1)\"> <input class=\"sldVal\" id=\"pctOpenVal-'+ii+'\" type=number value='+posPct(d.motorPos,d.motorPosAtCCW,d.motorPosAtCW)+' max=100 min=0 onchange=\"sync('+ii+',\"pctOpen\",2)\"></div><div class=\"btnRow\"><input class=\"lftBtn\" id=\"fobtn-'+ii+'\" type=button value=\"Full Open\" onclick=\"sendCmd('+ii+',\"O\")\"><input class=\"midBtn\" id=\"pobtn-'+ii+'\" type=button value=\"Go % Open\" onclick=\"sendCmd('+ii+',\"G\")\"><input class=\"rgtBtn\" id=\"fcbtn-'+ii+'\" type=button value=\"Full Close\" onclick=\"sendCmd('+ii+',\"C\")\"></div><div class=\"cfgPnl\" id=\"cfgPnl-'+ii+'\"><hr><span class=\"calTxt\" id=\"calTxt-'+ii+'\">'+calTxt+'</span><div class=\"sldRow\"><div class=\"sldLab\">CCW Lim</div><input class=\"sld\" id=\"ccwLimSld-'+ii+'\" type=range value='+d.motorPosAtCCW+' max='+d.motorPosAtFullCW+' min='+d.motorPosAtFullCCW+' oninput=\"sync('+ii+',\"ccwLim\",1)\"> <input class=\"sldVal\" id=\"ccwLimVal-'+ii+'\" type=number value='+d.motorPosAtCCW+' max='+d.motorPosAtFullCW+' min='+d.motorPosAtFullCCW+' onchange=\"sync('+ii+',\"ccwLim\",2)\"></div><div class=\"sldRow\"><div class=\"sldLab\">CW Lim</div><input class=\"sld\" id=\"cwLimSld-'+ii+'\" type=range value='+d.motorPosAtCW+' max='+d.motorPosAtFullCW+' min='+d.motorPosAtFullCCW+' oninput=\"sync('+ii+',\"cwLim\",1)\"> <input class=\"sldVal\" id=\"cwLimVal-'+ii+'\" type=number value='+d.motorPosAtCW+' max='+d.motorPosAtFullCW+' min='+d.motorPosAtFullCCW+' onchange=\"sync('+ii+',\"cwLim\",2)\"></div><div></div><div class=\"swRow\"><label class=\"sw\" id=\"sw-'+ii+'\"><input type=checkbox id=\"swChck-'+ii+'\" '+chckTxt+' onchange=\"openIsCCWUpd('+ii+')\" ><span class=\"sldSw\"></span></label><span class=\"swLab\" id=\"swLab-'+ii+'\">Open is CCW</span></div><label class=\"cfgInpLab\" for=\"devName-'+ii+'\">Device Name:</label> <input class=\"cfgInp\" id=\"devName-'+ii+'\" value=\"'+d.deviceName+'\"> <div class=\"btnRow\"><input class=\"cfgBtn\" id=\"updCfgBtn-'+ii+'\" type=button value=\"UPDATE CONFIG\"onclick=\"updateCfg('+ii+')\"><input class=\"cfgBtn\" id=\"updCfgBtn-'+ii+'\" type=button value=\"CALIBRATE\" onclick=\"sendCmd('+ii+',\"cal\")\"><br></div><hr></div><div class=\"btnRow\"><input class=\"tglBtn\" id=\"cfgBtn-'+ii+'\" type=button value=\"[+] Show Config Panel\" onclick=\"toggleCfg('+ii+')\"></div></div>';"
"console.log(addDiv);"
"items.push(addDiv);"
"}"
"  });"
